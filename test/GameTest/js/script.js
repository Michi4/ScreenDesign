...
class Platform{
    constructor(x, y, width, height){
        ...
        this.width = width ?? 256*0.2;
        this.height = height ?? 144*0.02;
    }
...
class Item{
    constructor(x, y, img, width, height){
        ...
        this.img = img ?? coin;
        this.width = width ?? 256/48;
        this.height = height ?? 256/48;
    }
...
function level0(){
    ...
    items = [
        ...
        //new Item(width*0.165, height*0.3, checkpoint, 256/48, 256/48),

        new Item(width*0.165, height*0.4, coin, 256/48, 256/48),
        new Item(width*0.265, height*0.5, coin, 256/48, 256/48),
        new Item(width*0.365, height*0.6, coin, 256/48, 256/48)

        /*
        new Item(width*0.51, height*0.6, coin, 256/48, 256/48),
        new Item(width*0.61, height*0.5, coin, 256/48, 256/48),
        new Item(width*0.71, height*0.4, coin, 256/48, 256/48),
        new Item(width*0.81, height*0.3, coin, 256/48, 256/48)
        */
    ];
}
function level1(){
    ...
    items = [
        new Item(width*0.95, height*0.45, coin, 256/48, 256/48),

        new Item(width*1.25, height*0.74, coin, 256/48, 256/48),
        new Item(width*1.51, height*0.45, coin, 256/48, 256/48),
        new Item(width*1.95, height*0.45, coin, 256/48, 256/48),

        new Item(width*2.25, height*0.74, coin, 256/48, 256/48),
        new Item(width*2.51, height*0.45, coin, 256/48, 256/48),
        new Item(width*2.95, height*0.45, coin, 256/48, 256/48),
    ];
}
// hi C:D
function level2(){
    ...
    items = [
        new Item(width*0.51, height*0.45, coin, 256/48, 256/48),
        new Item(width*0.95, height*0.45, coin, 256/48, 256/48),
...
function level3(){
    ...
    items = [
        new Item(width*0.69, height*0.6, coin, 256/48, 256/48),
        new Item(width*0.94, height*0.4, coin, 256/48, 256/48),
        
        new Item(width*1.05, height*0.25, coin, 256/48, 256/48),
        new Item(width*1.4, height*0.3, coin, 256/48, 256/48),

        new Item(width*1.79, height*0.64, coin, 256/48, 256/48),        
        new Item(width*2.1, height*0.5, coin, 256/48, 256/48),
        new Item(width*2.4, height*0.74, coin, 256/48, 256/48),
    ];
}
    ...
    */
    ...
    for(let i = 1; i < 9; i++){
        ...
        if(difficulty != 'run'){
            for(let j = 0; j < Math.floor(Math.random()*5); j++){
                ...
                items[i+j] = new Item(coinpos.x, coinpos.y, coin, 256/48, 256/48);
            }
        }
    }
    ...
    for(let i = 1; i < 9; i++){
        ...
        if(difficulty != 'run' && Math.random() > 0.5){
            coinpos.x = Math.random() * (platforms[i].width+platforms[i].position.x - platforms[i].position.x) + platforms[i].position.x;
            coinpos.y = Math.random() * (platforms[i].position.y-0.06*height - (platforms[i].position.y-0.3*height)) +  (platforms[i].position.y-0.3*height);
            items[i] = new Item(coinpos.x, coinpos.y, coin, 256/48, 256/48);
        } 
    }
    platforms[9] = new Platform(platforms[8].position.x+platforms[8].width + (Math.random()*0.3), height*0.8, width*0.5, height*0.2);
